...
# Шестандцетеричная ассоциация с двоичным предсавлением
astv_stot_16th = {
    "0": "0000", "1": "0001", "2": "0010", "3": "0011", "4": "0100", "5": "0101", "6": "0110", "7": "0111",
    "8": "1000", "9": "1001", "a": "1010", "b": "1011", "c": "1100", "d": "1101", "e": "1110", "f": "1111"}


# Двоичная ассоциация с шестандцетеричным предсавлением
astv_ttos_16th = {
    "0000": "0", "0001": "1", "0010": "2", "0011": "3", "0100": "4", "0101": "5", "0110": "6", "0111": "7",
    "1000": "8", "1001": "9", "1010": "a", "1011": "b", "1100": "c", "1101": "d", "1110": "e", "1111": "f"}


# Десятичноая ассоциация с шестнадцетеричным представлением
astv_dtos_16th = {
...
# Лист перестановки π'
π_list = [252, 238, 221, 17, 207, 110, 49, 22, 251, 196, 250, 218, 35, 197, 4, 77, 233,
...
# Лист обратный перестановки π'
rπ_list = [0 for i in range(256)]
for i in range(256):
    r = π_list[i]
    rπ_list[r] = i
